        ...
        if (event.registration_required):
            ...
            if not user.is_authenticated:
                ...
                if (event.registration_required) and (checkClass(user, event)) and (event.registration_start_time <= timezone.now()) and (context['event_not_full'] and (komite_open)):
                    ...
                    subject = "Du er nå påmeldt til: %s" % (event.title)
                    message = "Du er nå meldt på til \"%s\".\n\nP.S. Jeg skal lage en freshere e-post senere. Lover!" % (event.title)
                ...
                # Check if waiting list was pressed
                    ...
                    subject = "Du står nå på venteliste til: %s" % (event.title)
                    message = "Du står nå på venteliste til \"%s\".\n\nP.S. Jeg skal lage en freshere e-post senere. Lover!"
            ...
            if subject is not None:
                print("Send epost til")
                send_event_confirmation_mail(subject, message, user.email);
